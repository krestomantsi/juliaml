...
struct Dense
    ...
    bias::Matrix{Float32}
    activation::Union{typeof(relu),typeof(swish),typeof(none_activation)}
    activation_prime::Union{typeof(relu_prime),typeof(swish_prime),typeof(none_activation_prime)}
end
...
# @code_warntype model.layers[1](x)
